...
class Solution {
    ...
    public int[] solution(String[] info, String[] query) {
        ...
        for (int i = 0; i < query.length; i++) {
            // " and " -> "" 로 replace하면 검색조건끼리만 붙은 "문자열 공백 점수" 이렇게 됨
            query[i] = query[i].replaceAll(" and ", "");
            // 공백기준으로 split 하면 [문자열, 점수] 이렇게 됨
    ...
    // 검색 가능한 조합별로 점수를 넣어놓는 함수 : idea
    public static void combination(String[] p, String str, int cnt) {
        if (cnt == 4) {
